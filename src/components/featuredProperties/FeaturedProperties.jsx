...
const FeaturedProperties = () => {
  return (
    <div className="fp">
        ...
        <div className="fpItem">
            <img src="https://zafigo.com/wp-content/uploads/2016/09/1_W_Taipei.jpg" alt="" className="fpImg" />
        ...
        <div className="fpItem">
            <img src="https://www.travelworld.co/wp-content/uploads/2020/09/The-10-Best-Five-Star-Hotels-in-Jaipur.jpg" alt="" className="fpImg" />
