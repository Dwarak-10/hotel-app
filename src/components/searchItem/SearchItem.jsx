  ...
  return (
   <div className="searchItem">
    ...
    <div className="siDesc">
        ...
        <span className="siCancelOpSubtitle">You can cancel lateer, so lock in this great price today!</span>
    ...
    <div className="siDetails">
        ...
        <div className="siDetailTexts">
          ...
          <button className="siCheckButton" onClick={handleRedirect}>See availability</button>
        </div>
      </div>
   </div>
  );
